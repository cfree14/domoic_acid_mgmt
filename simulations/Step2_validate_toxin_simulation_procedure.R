...
# Export
ggsave(g1, filename=file.path(plotdir, "FigSX_toxin_grid_examples_diag.png"),
...
# Export figure
ggsave(g2, filename=file.path(plotdir, "FigSX_toxin_grid_examples_seed.png"),
       width=6.5, height=6.5, units="in", dpi=600)
...
# Export figure
ggsave(g3, filename=file.path(plotdir, "FigSX_toxin_grid_examples_merged.png"),
       width=6.5, height=6.5, units="in", dpi=600)
